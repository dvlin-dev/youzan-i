...
export async function seed() {
  ...
  skus.forEach((s, i) => {
    ...
    if (R() > 0.25) {
      ...
      post({
        ...
        delta: q,
        bizType: "采购到货",
        docNo: "IN-2026" + (415 + (i % 20)),
        ts: daysAgo(Math.round(6 + R() * 18), "10:12"),
      });
      stock += q;
    }
    if (R() > 0.2) {
      ...
      if (q > 0)
        post({
          ...
          delta: -q,
          bizType: "销售出库",
          docNo: "OUT-2026" + (420 + (i % 25)),
          ts: daysAgo(Math.round(1 + R() * 12), "14:40"),
        });
    }
  });
  ...
  post({
    ...
    delta: 100,
    bizType: "采购到货",
    docNo: "IN-20260408-012",
    ts: d("2026-04-08T09:30:00+08:00"),
    poRef: "PO-20260405-001",
    scanned: false,
    qc: true,
  });
  post({
    ...
    delta: -30,
    bizType: "销售出库",
    docNo: "OUT-20260420-031",
    ts: d("2026-04-20T14:05:00+08:00"),
  });
  post({
    skuCode: "AW2024-3301-黑-M",
    delta: 60,
    bizType: "期初",
    docNo: "INIT-2026Q2",
    ts: daysAgo(60),
  ...
  post({
    ...
    delta: 90,
    bizType: "采购到货",
    docNo: "IN-20260524-002",
    ts: d("2026-05-24T10:10:00+08:00"),
    poRef: "PO-20260524-002",
    scanned: false,
    qc: false,
  });
  post({
    ...
    delta: -30,
    bizType: "销售出库",
    docNo: "OUT-20260520-066",
    ts: d("2026-05-20T15:00:00+08:00"),
  });
  // ③ 重复入库：卡其/L 同一到货单号录了两次 +48
  post({
    skuCode: "AW2024-9902-卡其-L",
    delta: 50,
    bizType: "期初",
    docNo: "INIT-2026Q2",
    ts: daysAgo(60),
  ...
  post({
    ...
    delta: 48,
    bizType: "采购到货",
    docNo: "IN-20260518-088",
    ts: d("2026-05-18T09:20:00+08:00"),
    poRef: "PO-20260515-004",
    scanned: true,
    qc: true,
  });
  post({
    ...
    bizType: "采购到货",
    docNo: "IN-20260518-088",
    ts: d("2026-05-18T16:40:00+08:00"),
    poRef: "PO-20260515-004",
    scanned: false,
    qc: true,
  });
  post({
    ...
    delta: -6,
    bizType: "销售出库",
    docNo: "OUT-20260526-091",
    ts: d("2026-05-26T11:00:00+08:00"),
  });
  // ④ 在途未录：蓝/L 快照(16:00)后才入账的到货 +40 → 假差异（账面快照=50，现库存=90）
  post({
    skuCode: "AW2024-2087-蓝-L",
    delta: 80,
    bizType: "期初",
    docNo: "INIT-2026Q2",
    ts: daysAgo(60),
  ...
  post({
    ...
    delta: -30,
    bizType: "销售出库",
    docNo: "OUT-20260522-070",
    ts: d("2026-05-22T14:20:00+08:00"),
  });
  post({
    skuCode: "AW2024-2087-蓝-L",
    delta: 40,
    bizType: "采购到货",
    docNo: "IN-20260530-022",
    ts: d("2026-05-30T16:30:00+08:00"),
    poRef: "PO-20260528-006",
    scanned: true,
    qc: true,
  });
  // ⑤ 实物损耗（查无解释）
  ...
  post({
    ...
    delta: 30,
    bizType: "采购到货",
    docNo: "IN-20260510-040",
    ts: d("2026-05-10T09:00:00+08:00"),
    scanned: true,
    qc: true,
  });
  post({
    ...
    delta: -10,
    bizType: "销售出库",
    docNo: "OUT-20260515-052",
    ts: d("2026-05-15T10:30:00+08:00"),
  });
  post({
    skuCode: "AW2024-6620-灰-XL",
    delta: 70,
    bizType: "期初",
    docNo: "INIT-2026Q2",
    ts: daysAgo(60),
  ...
  post({
    ...
    delta: 40,
    bizType: "采购到货",
    docNo: "IN-20260512-045",
    ts: d("2026-05-12T09:00:00+08:00"),
    scanned: true,
    qc: true,
  });
  post({
    ...
    delta: -22,
    bizType: "销售出库",
    docNo: "OUT-20260524-080",
    ts: d("2026-05-24T16:00:00+08:00"),
  });
  post({
    skuCode: "AW2024-1109-白-M",
    delta: 50,
    bizType: "期初",
    docNo: "INIT-2026Q2",
    ts: daysAgo(60),
  ...
  post({
    ...
    delta: -10,
    bizType: "销售出库",
    docNo: "OUT-20260518-060",
    ts: d("2026-05-18T11:00:00+08:00"),
  });
  // 疑错发：4408黑/M 近期大额出库
  post({
  ...
  post({
    ...
    delta: -30,
    bizType: "销售出库",
    docNo: "OUT-20260527-095",
    ts: d("2026-05-27T15:30:00+08:00"),
  });
